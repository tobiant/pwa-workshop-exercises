define(["exports"], (function (t) {
    ...
    const c = {
        ...
        }, h = t => [c.prefix, t, c.suffix].filter((t => t && t.length > 0)).join("-"), u = t => t || h(c.precache),
        l = t => t || h(c.runtime);
    ...
    async function g(t, e) {
        ...
        const i = t.clone(), r = {headers: new Headers(i.headers), status: i.status, statusText: i.statusText},
            o = e ? e(r) : r, a = function () {
                if (void 0 === y) {
    ...
    class U {
        ...
        async cacheMatch(t) {
            const e = q(t);
            let s;
            const {cacheName: n, matchOptions: i} = this.l, r = await this.getCacheKey(e, "read"),
        ...
        async cachePut(t, e) {
            ...
            if (!e) throw new s("cache-put-with-no-response", {url: (o = r.url, new URL(String(o), location.href).href.replace(new RegExp(`^${location.origin}`), ""))});
            var o;
            const a = await this.v(e);
            if (!a) return !1;
            const {cacheName: c, matchOptions: h} = this.l, u = await self.caches.open(c),
                l = this.hasCallback("cacheDidUpdate"), f = l ? await async function (t, e, s, n) {
                    const i = R(e.url, s);
                    if (e.url === i) return t.match(e, n);
                    const r = Object.assign(Object.assign({}, n), {ignoreSearch: !0}), o = await t.keys(e, r);
        ...
        * iterateCallbacks(t) {
            for (const e of this.l.plugins) if ("function" == typeof e[t]) {
                const s = this.m.get(e), n = n => {
    ...
    class L extends class {
        ...
        handleAll(t) {
            ...
            const e = t.event, s = "string" == typeof t.request ? new Request(t.request) : t.request,
                n = "params" in t ? t.params : void 0, i = new U(this, {event: e, request: s, params: n}),
                r = this.q(i, s, e);
        ...
        async q(t, e, n) {
            ...
            try {
                if (i = await this.L(e, t), !i || "error" === i.type) throw new s("no-response", {url: e.url})
            } catch (s) {
                if (s instanceof Error) for (const r of t.iterateCallbacks("handlerDidError")) if (i = await r({
                    error: s,
                    event: n,
                    request: e
                }), i) break;
        ...
        async O(t, e) {
            ...
            if (!this._) throw new s("missing-precache-entry", {cacheName: this.cacheName, url: t.url});
            {
                ...
                n = await e.fetch(new Request(t, {integrity: r || s})), s && o && (this.N(), await e.cachePut(t, n.clone()))
            }
            return n
        }
    ...
    L.defaultPrecacheCacheabilityPlugin = {cacheWillUpdate: async ({response: t}) => !t || t.status >= 400 ? null : t}, L.copyRedirectedCacheableResponsesPlugin = {cacheWillUpdate: async ({response: t}) => t.redirected ? await g(t) : t};
    ...
    class b {
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                const {cacheKey: t, url: i} = w(n), r = "string" != typeof n && n.revision ? "reload" : "default";
                if (this.k.has(i) && this.k.get(i) !== t) throw new s("add-to-cache-list-conflicting-entries", {
                    firstEntry: this.k.get(i),
                    secondEntry: t
                });
                if ("string" != typeof n && n.integrity) {
                    if (this.T.has(t) && this.T.get(t) !== n.integrity) throw new s("add-to-cache-list-conflicting-integrities", {url: i});
        ...
        install(t) {
            return f(t, (async () => {
                ...
                for (const [e, s] of this.k) {
                    const n = this.T.get(s), i = this.K.get(e),
...
//# sourceMappingURL=workbox-22e1a5cc.js.map
